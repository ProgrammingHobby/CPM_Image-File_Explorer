...
#ifndef _CIFE_GUI_DESIGNS_UI_RENAMEFILEDIALOG_BASE_CLASSES_HPP
#define _CIFE_GUI_DESIGNS_UI_RENAMEFILEDIALOG_BASE_CLASSES_HPP
...
public:
    wxStaticText* GetTextOldFileName() { return textOldFileName; }
    wxTextCtrl* GetEditOldUser() { return editOldUser; }
    wxTextCtrl* GetEditOldFileName() { return editOldFileName; }
    wxStaticText* GetTextNewFileName() { return textNewFileName; }
    wxTextCtrl* GetEditNewUser() { return editNewUser; }
    wxTextCtrl* GetEditNewFileName() { return editNewFileName; }
    wxCheckBox* GetCheckboxChangeUser() { return checkboxChangeUser; }
