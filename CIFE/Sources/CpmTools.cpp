...
// --------------------------------------------------------------------------------
void CpmTools::readFileFromImage(wxString fileName, wxString filePath, int userNumber,
...
// --------------------------------------------------------------------------------
int CpmTools::cpm2unix(const char *unixfilename, const char *cpmfilename, bool text,
                       bool preserve) {
    CpmFs::CpmInode_t ino;
    int exitcode = 0;
