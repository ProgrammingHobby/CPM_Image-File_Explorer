...
Objects0=../build-$(ConfigurationName)/CIFE/MainWindow.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/CpmTools.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/RenameFileDialog.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/CpmGuiInterface.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/Ui_RenameFileDialog.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/Ui_MainWindow.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/Ui_FileAttributesDialog.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/Ui_RenameFileDialog_bitmaps.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/main.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/CreateFileDialog.cpp$(ObjectSuffix) \
	../build-$(ConfigurationName)/CIFE/Ui_CreateFileDialog_cife_bitmaps.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/FileAttributesDialog.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/Ui_CreateFileDialog.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/FileProtectionsDialog.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/Ui_FileProtectionsDialog_bitmaps.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/Ui_MainWindow_bitmaps.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/Ui_FileAttributesDialog_bitmaps.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/CIFE/Ui_FileProtectionsDialog.cpp$(ObjectSuffix) 
