...
void wxCrafterbA4dhxInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/Ui_MainWindow_bitmaps.cpp$_home_uwe_Programming_wxWidgets_Projekte_CPM_Image-File_Explorer_CIFE_Ui_MainWindow_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
