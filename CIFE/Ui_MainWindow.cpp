...
Ui_MainWindow::Ui_MainWindow(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style)
    ...
    menuItemSelectAll->SetBitmap(wxXmlResource::Get()->LoadBitmap(wxT("select-all")));
    ...
    menuItemPermissions->SetBitmap(wxXmlResource::Get()->LoadBitmap(wxT("permission")));
    ...
    menuItemCreateNew->SetBitmap(wxXmlResource::Get()->LoadBitmap(wxT("create")));
