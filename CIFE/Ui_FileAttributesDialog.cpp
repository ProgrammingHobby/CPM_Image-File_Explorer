...
Ui_FileAttributesDialog::Ui_FileAttributesDialog(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style)
    ...
    checkboxF1 = new wxCheckBox(panelFileAttributes, wxID_CHECK_F1, _("F1 (used by M/PM)"), wxDefaultPosition, wxDLG_UNIT(panelFileAttributes, wxSize(-1, -1)), 0);
    checkboxF1->SetValue(false);
    sizerFileAttributes->Add(checkboxF1, 0, wxLEFT | wxRIGHT | wxTOP, WXC_FROM_DIP(4));
    checkboxF2 = new wxCheckBox(panelFileAttributes, wxID_CHECK_F2, _("F2 (used by M/PM)"), wxDefaultPosition, wxDLG_UNIT(panelFileAttributes, wxSize(-1, -1)), 0);
    checkboxF2->SetValue(false);
    sizerFileAttributes->Add(checkboxF2, 0, wxLEFT | wxRIGHT, WXC_FROM_DIP(4));
    checkboxF3 = new wxCheckBox(panelFileAttributes, wxID_CHECK_F3, _("F3 (used by M/PM)"), wxDefaultPosition, wxDLG_UNIT(panelFileAttributes, wxSize(-1, -1)), 0);
    checkboxF3->SetValue(false);
    sizerFileAttributes->Add(checkboxF3, 0, wxLEFT | wxRIGHT, WXC_FROM_DIP(4));
    checkboxF4 = new wxCheckBox(panelFileAttributes, wxID_CHECK_F4, _("F4 (used by M/PM)"), wxDefaultPosition, wxDLG_UNIT(panelFileAttributes, wxSize(-1, -1)), 0);
